...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalog', '0003_auto_20210510_1642'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_orders', to='catalog.customer', verbose_name='Покупатель')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='related_order', to='catalog.Order', verbose_name='Заказы покупателя'),
        ),
    ]
